...
#     video_array = numpy.random.rand(100, 100, 3) * 255
#     video = Image.fromarray(video_array.astype('uint8'))
#     video.save(f"{path}/{get_random_filename()}.{choice(videos).lower()}")
